...
def write_raster(stack_path, etrf_name,image, path):
    """
...
def raster_dict_maker(stack_location):
...
def run():
    ...
    # First Adjustment, good results. Going to increase.
    # Adj_low = 0.06
    # Adj_high = -0.14

    # Second Adjustment - 10/17/2017
    # Adj_low = 0.10
    # Adj_high = -0.18
    ...
    stack_path = os.path.join(drive_path, "jan_metric", 'stacking_histogram_ETrF_adj_5') # 'for_stacking'
    ...
    raster_dict = raster_dict_maker(stack_path)
