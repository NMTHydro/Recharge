...
def warp_jpl(jpl_filepath, etrm_geo, output_path):
    ...
    warp = '/Users/dcadol/.conda/envs/Recharge_2/bin/gdalwarp -overwrite -t_srs {tsrs} -r {resample} -te {xmin} {ymin} {xmax} {ymax} -ts {cols} {rows} -of GTiff {current_file} {output_file}'.format(tsrs=t_srs, resample=resample_method, xmin=xmin, ymin=ymin, xmax=xmax, ymax=ymax, cols=cols, rows=rows, current_file=jpl_filepath, output_file=out_loc)
...
if __name__ == "__main__":
    ...
    # === N_Central_NM (espanola) geographic inputs ===

    xmin = 289257.0000000000000000
    ymin = 3884913.0000000000000000
    xmax = 519507.0000000000000000
    ymax = 4018663.0000000000000000
    ...
    output_path = '/Users/dcadol/Desktop/academic_docs_II/JPL_Data/JPL_calibration_approach/jpl_etrm_espanola_warp_PT'
