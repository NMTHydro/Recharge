...
output = '/Volumes/Seagate_Blue/jpl_research/jpl_WE/jpl_depletions'

eta_output = '/Volumes/Seagate_Blue/jpl_research/jpl_WE/jpl_cum_eta'
prism_output = '/Volumes/Seagate_Blue/jpl_research/jpl_WE/jpl_cum_prism'
