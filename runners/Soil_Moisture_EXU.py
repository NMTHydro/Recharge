...
r_dur = []
r_dep = []
with open('G:\\Observations\\Soil_Moisture\\runoff_11.csv') as csvDataFile:
...
p_dur = []
p_dep = []
with open('G:\\Observations\\Soil_Moisture\\rain_90.csv') as csvDataFile:
    csvReader = csv.reader(csvDataFile)
    for row in csvReader:
...
months = []
days = []
#doesn't matter which file, as long as PRISM. Since this is for entrie time series
